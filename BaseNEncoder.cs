...
{
    public class BaseNEncoder : IEnumerator<string>, IEnumerable, IEnumerable<string>
    {
        int baseN;
        int generator;
        List<char> mapping;
        ...
        public BaseNEncoder(int baseN, IEnumerable<char> mapping)
        {
        ...
        public string Encode(int d)
        {
            ...
            if (r - d == 0)
                return toChar(r);
            return Encode(((d - r) / baseN)) + toChar(r);
        }
        ...
        public int Decode(string value)
        {
            ...
            {
                return ((mapping.IndexOf(c)) * Math.Pow(baseN, index));
            }).Sum();
            return i;
        }
